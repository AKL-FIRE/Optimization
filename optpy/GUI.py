...
class MyApp():
    ...
    def run(self):
        ...
        self.group6 = tk.LabelFrame(self.root, text='2.进化算法（单变量高维优化）',padx=5, pady=5)
        ...
        self.group3 = tk.LabelFrame(self.root, text='2.参数输入：', padx=5, pady=5)
        ...
        self.group4.grid(row=2, column=1, padx=10, pady=10)
